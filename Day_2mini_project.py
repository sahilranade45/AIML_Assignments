...
Project: Python Vault

Description:
A simple Python-based mini game created to demonstrate
arithmetic operators, input, variables, and basic calculations.
"""
...
PS C:\Users\ADMIN\OneDrive\Desktop\AIMLDB> python Day_2mini_project.py
SYSTEM: You are locked inside the Python Vault.
Your Mission: Collect enough power to escape the vault.
